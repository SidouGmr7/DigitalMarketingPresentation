    ...
    <div className='py-10 overflow-hidden  bg-slate-900'>
      <div className='flex md:flex-row flex-col items-center relative max-w-6xl md:p-4 md:mx-auto gap-10'>
        ...
        <div className='w-[65%] items-center'>
          <p className='text-[#68fff1] text-2xl mb-10 font-bold relative before:absolute before:rounded-lg before:w-20 before:h-1 before:-bottom-3 before:bg-[#68fff1]'>
            Liens utiles
          </p>
          <SocialItem name='Strategie Digital' Color='text-[#68fff1]' />
          <SocialItem name='UI Designs' Color='text-[#68fff1]' />
          <SocialItem name='Rédaction de contenu' Color='text-[#68fff1]' />
          <SocialItem name='Strategie Marketing' Color='text-[#68fff1]' />
          <SocialItem name='Developpement Web' Color='text-[#68fff1]' />
          <SocialItem name='Media Sociaux' Color='text-[#68fff1]' />
        </div>
        <div className='w-[65%] items-center'>
          <p className='text-[#68fff1] text-2xl mb-10 font-bold relative before:absolute before:rounded-lg before:w-20 before:h-1 before:-bottom-3 before:bg-[#68fff1]'>
            Contact
          </p>
          <SocialItem name='+213 554 02 46 41' Color='text-[#68fff1]' />
          <SocialItem name='+447874384147' Color='text-[#68fff1]' />
          <SocialItem
